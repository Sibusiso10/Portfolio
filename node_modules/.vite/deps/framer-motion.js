...
var createDomVisualElement = (Component3, options) => {
  return isSVGComponent(Component3) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== import_react18.Fragment
  });
};
...
function PopChild({ children, isPresent: isPresent2 }) {
  const id4 = (0, import_react19.useId)();
  ...
  const { nonce } = (0, import_react19.useContext)(MotionConfigContext);
...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode }) => {
  ...
  const memoizedOnExitComplete = (0, import_react20.useCallback)((childId) => {
...
var AnimatePresence = ({ children, exitBeforeEnter, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const presentChildren = (0, import_react22.useMemo)(() => onlyElements(children), [children]);
  const presentKeys = presentChildren.map(getChildKey);
  const isInitialRender = (0, import_react22.useRef)(true);
  const pendingPresentChildren = (0, import_react22.useRef)(presentChildren);
  const exitComplete = useConstant(() => /* @__PURE__ */ new Map());
  const [diffedChildren, setDiffedChildren] = (0, import_react22.useState)(presentChildren);
  const [renderedChildren, setRenderedChildren] = (0, import_react22.useState)(presentChildren);
  useIsomorphicLayoutEffect(() => {
  ...
  const { forceRender } = (0, import_react22.useContext)(LayoutGroupContext);
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  const context = (0, import_react23.useMemo)(() => config, [
...
function useMotionValue(initial) {
  ...
  const { isStatic } = (0, import_react29.useContext)(MotionConfigContext);
  if (isStatic) {
    const [, setLatest] = (0, import_react29.useState)(initial);
    (0, import_react29.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function useSpring(source, config = {}) {
  ...
  const activeSpringAnimation = (0, import_react30.useRef)(null);
  const value = useMotionValue(isMotionValue(source) ? toNumber(source.get()) : source);
  const latestValue = (0, import_react30.useRef)(value.get());
  const latestSetter = (0, import_react30.useRef)(() => {
  });
...
function useAnimationFrame(callback) {
  const initialTimestamp = (0, import_react33.useRef)(0);
...
function useReducedMotionConfig() {
  ...
  const { reducedMotion } = (0, import_react35.useContext)(MotionConfigContext);
...
function useCycle(...items) {
  const index = (0, import_react36.useRef)(0);
  const [item, setItem] = (0, import_react36.useState)(items[index.current]);
  const runCycle = (0, import_react36.useCallback)(
    (next) => {
...
function useInView(ref, { root, margin, amount, once = false } = {}) {
  const [isInView, setInView] = (0, import_react37.useState)(false);
...
function useInstantTransition() {
  ...
  const unlockOnFrameRef = (0, import_react39.useRef)();
...
function useAnimatedState(initialState) {
  const [animationState, setAnimationState] = (0, import_react41.useState)(initialState);
...
function useInvertedScale(scale2) {
  ...
  const { visualElement } = (0, import_react42.useContext)(MotionContext);
...
var ReorderContext = (0, import_react43.createContext)(null);
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order = [];
  const isReordering = (0, import_react44.useRef)(false);
...
var ReorderGroup = (0, import_react44.forwardRef)(ReorderGroupComponent);
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  const Component3 = useConstant(() => motion[as]);
  const context = (0, import_react45.useContext)(ReorderContext);
  const point2 = {
...
var ReorderItem = (0, import_react45.forwardRef)(ReorderItemComponent);
